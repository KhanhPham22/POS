...
/**
 * A frame for managing warehouse-related operations, displaying the WarehousePanel.
 */
public class WarehouseFrame extends JFrame implements SidebarPanel.SidebarListener {
    ...
    /**
     * Constructs a WarehouseFrame with the specified services and username.
     */
    public WarehouseFrame(SupplierService supplierService, ItemService itemService, StoreServiceImpl storeService,
            PersonService personService, HashService hashService, AuthenticationService authService,
            ProductService productService, CategoryService categoryService, DashboardService dashboardService,InvoiceService invoiceService,
            String username) {
    ...
    private void loadWarehousePanel() {
        WarehousePanel warehousePanel = new WarehousePanel(supplierService, itemService, storeService);
